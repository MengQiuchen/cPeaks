...
if __name__ == "__main__":
    ...
    parser.add_argument("--fragment_path", '-f',required=True,type=str, default=None,help="path of mtx file")
    parser.add_argument("--cPeaks_path", type=str, default='cPeaks.bed',help="path of cPeaks file")
    parser.add_argument("--barcode_path", '-b',type=str, default=None,help="path of barcode file")
    parser.add_argument("--output", '-o',type=str, default='./res',help="path to save h5ad file")
